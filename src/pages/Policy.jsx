        ...
        <div className="policy-text-container">
          ...
          <p>
            ...
            <h3>"Personal information" includes such items as:</h3> 
              ...
              <p>
              SignalSynch is glad to receive your comments concerning this "Privacy Policy". In case you think that SignalSynch does not follow the rules and violate this Statement, contact us at support@signalSynch.com We guarantee that we will take commercially reasonable efforts to discover and solve the problem.
              </p>
            </div>
      </div>
      <About />
